...
class Env2DAirfoil:
    ...
    def __init__(self, Re=2500, attack_angle=pi / 7.2, probes_mode=0, probe_locations_mode=0, save_data=0,
                 save_fre=400):
        ...
        self.snap_num = 30
        self.actuator_num = 2
        self.snapshot_fre = 50  # The snapshots are updated every 50 time steps.
